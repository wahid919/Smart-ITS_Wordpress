<div class="site-bar elation-bottombar-one <?php 
...
echo  ( get_theme_mod( 'elation-add-botbar-fullcart', customizer_library_get_default( 'elation-add-botbar-nofullcart' ) ) ? sanitize_html_class( 'elation-bottombar-fullcart' ) : sanitize_html_class( 'elation-bottombar-nofullcart' ) ) ;
?>">
