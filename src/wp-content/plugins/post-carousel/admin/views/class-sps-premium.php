...
class SPS_Premium {
	...
	public function happy_users( $username = 'shapedplugin', $args = array() ) {
		if ( $username ) {
			...
			$data = array(
				'error' => __( 'No data found!', 'post-carousel' ),
			);
		}
				...
				<div class="row">
					<div class="sp-sps__col-xl-6">
						<div class="sp-sps__banner-content">
							<h2 class="sp-sps__font-30 main-color sp-sps__font-weight-500"><?php esc_html_e( 'Upgrade To Smart Post Show Pro', 'post-carousel' ); ?></h2>
							<h4 class="sp-sps__mt-10 sp-sps__font-18 sp-sps__font-weight-500"><?php echo wp_kses_post( 'The Best <strong>Post Grid and Filter</strong> Plugin For WordPress!', 'post-carousel' ); ?> </h4>
			...
			<div class="sp-sps__container">
				...
				?>
					...
					if ( isset( $plugin_data['plugins'] ) ) {
						...
						echo esc_attr( $plugin_downloads['http://wordpress.org/plugins/post-carousel'] );
					} else {
						echo '309000';
					}
					?>
					...
					<div class="count-item">
						...
						if ( isset( $plugin_data['plugins'] ) ) {
							...
							echo esc_attr( $plugin_rating['http://wordpress.org/plugins/post-carousel'] ) . '/5';
						} else {
							echo '4.7/5';
						}
						?>
			...
			<div class="sp-sps__container">
				...
				<div class="video-area text-center">
					...
					<div class="video-button">
						<a class="js-video-button" href="#" data-channel="youtube" data-video-url="//www.youtube.com/embed/XGv-pzFlPLg">
