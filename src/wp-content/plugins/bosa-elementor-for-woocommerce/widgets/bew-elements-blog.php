...
class BEW_Blog extends BEW_Settings {
    ...
    protected function register_controls() {
		...
		$this->add_control(
			'read_more_text',
			[
				'label' 		=> __('Learn More Text', 'bosa-elementor-for-woocommerce'),
				'type' 			=> Controls_Manager::TEXT,
				'default' 		=> __('Learn More', 'bosa-elementor-for-woocommerce'),
				'label_block' 	=> true,
				'dynamic' 		=> [ 'active' => true ],
			]
		);
		...
		$this->start_controls_section(
			'section_grid',
			[
				'label' 		=> __('Grid', 'bosa-elementor-for-woocommerce'),
		...
		$this->add_control(
			...
			[
				'label' 		=> __('Background Color', 'bosa-elementor-for-woocommerce'),
				'type' 			=> Controls_Manager::COLOR,
				'selectors' 	=> [
					'{{WRAPPER}} .bew-elements-widgets .bew-elements-post-inner' => 'background-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			'grid_border_color',
			[
				'label' 		=> __('Border Color', 'bosa-elementor-for-woocommerce'),
				'type' 			=> Controls_Manager::COLOR,
				'selectors' 	=> [
					'{{WRAPPER}} .bew-elements-widgets .bew-elements-post-inner' => 'border-color: {{VALUE}};',
				],
			]
		);
		...
		$this->get_margin( 'blog_margin', '.bew-elements-container .bew-elements-post-inner' );

		$this->get_padding( 'blog_padding', '.bew-elements-container .bew-elements-post-inner' );
		...
		$this->get_normal_color('categories_hover_color', esc_html__( 'Color: Hover', 'bosa-elementor-for-woocommerce' ), '.bew-blog-categories a:hover', 'color');
		...
		$this->start_controls_section(
			'bew_elements_blog_button_style',
			[
		...
		$this->get_title_typography('button_typography', '.read-more-blog');
		...
		$this->get_normal_color('btn_color', esc_html__('Color', 'bosa-elementor-for-woocommerce'), '.read-more-blog', 'color');
		...
		$this->get_normal_color('btn_hov_bg_color', esc_html__('Background Color', 'bosa-elementor-for-woocommerce'), '.read-more-blog:hover', 'background-color');

		$this->get_normal_color('btn_hov_color', esc_html__('Color', 'bosa-elementor-for-woocommerce'), '.read-more-blog:hover', 'color');

		$this->get_normal_color('btn_hov_border_color', esc_html__('Border Color', 'bosa-elementor-for-woocommerce'), '.read-more-blog:hover', 'border-color');
		
		$this->end_controls_tab();
		
		$this->end_controls_tabs();

		$this->get_margin('btn_margin', '.bew-blog-btn');

		$this->get_padding('btn_padding', '.read-more-blog');
                    ...
                    <article class="bew-elements-post-inner">
	                    ...
	                    <div class="bew-blog-content">
							...
							<div class="bew-blog-btn">
								<a href="<?php the_permalink(); ?>" class="read-more-blog"><?php echo esc_html( $read_more ); ?></a>
							</div>
							<?php endif; ?>
	                    </div>
                    </article>
