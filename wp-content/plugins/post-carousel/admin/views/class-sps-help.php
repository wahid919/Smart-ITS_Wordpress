	...
	public function help_page_callback() {
		...
		<section class="sp-sps__help header">
			...
			<div class="video-area">
				<iframe width="560" height="315" src="https://www.youtube.com/embed/videoseries?list=PLoUb-7uG-5jPJ4tAoZbF_angfWNGeXdye" frameborder="0" allowfullscreen=""></iframe>
			</div>
			...
			<div class="upgrade-info">
				<div class="container">
					<div class="row">
						...
						<div class="col-lg-6">
							<ul class="upgrade-list">
								<li><img src="<?php echo esc_url( SP_PC_URL . 'admin/assets/img/images/checkmark.svg' ); ?>" alt=""><span>Replace Layout on The Default Blog, WooCommerce Shop, Category, Tag, Taxonomy, Search, Author, Date... Pages, and Post Types. <span class="spcp-new-ft">New</span></span></li>
