...
function customizer_library_get_all_fonts() {
	$heading1       = array( 1 => array( 'label' => sprintf( '--- %s ---', __( 'Standard Fonts', 'elation' ) ) ) );
	$standard_fonts = customizer_library_get_standard_fonts();
	$heading2       = array( 2 => array( 'label' => sprintf( '--- %s ---', __( 'Google Fonts', 'elation' ) ) ) );
...
function customizer_library_get_google_font_subsets() {
	return array(
		'all'          => __( 'All', 'elation' ),
		'cyrillic'     => __( 'Cyrillic', 'elation' ),
		'cyrillic-ext' => __( 'Cyrillic Extended', 'elation' ),
		'devanagari'   => __( 'Devanagari', 'elation' ),
		'greek'        => __( 'Greek', 'elation' ),
		'greek-ext'    => __( 'Greek Extended', 'elation' ),
		'khmer'        => __( 'Khmer', 'elation' ),
		'latin'        => __( 'Latin', 'elation' ),
		'latin-ext'    => __( 'Latin Extended', 'elation' ),
		'vietnamese'   => __( 'Vietnamese', 'elation' ),
	);
}
endif;
...
function customizer_library_get_standard_fonts() {
	return array(
		'serif' => array(
			'label' => _x( 'Serif', 'font style', 'elation' ),
			'stack' => 'Georgia,Times,"Times New Roman",serif'
		),
		'sans-serif' => array(
			'label' => _x( 'Sans Serif', 'font style', 'elation' ),
			'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif'
		),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'elation' ),
